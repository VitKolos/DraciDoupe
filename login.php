...
<html>
    ...
    <body>
        <div style="text-align:center">
			<?php if (isset($_GET["start"])) {echo '<div style="background-color:#90EE90; color:white;"><small><b>Vítejte v online hře Dračí doupě, kterou vytvořil Bajker006.<br>Nejprve se, prosím, přihlašte nebo zaregistrujte.</b></small></div>';} echo '<div style="text-align:left; display:block;"><small><a href=".">Zpět</a></small></div>'; ?>
